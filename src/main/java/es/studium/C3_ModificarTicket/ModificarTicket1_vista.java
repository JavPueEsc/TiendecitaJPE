...
/**
 * La clase <b>ModificarTicket1_vista</b> contiene los componentes gráficos de la ventana 
 * 'Modificar Tickets - Selección'.
 * @author Javier Pueyo
 * @version 2.0
 */
public class ModificarTicket1_vista extends JFrame {
	...
	public ModificarTicket1_vista() {
		...
		setTitle("Modificar Tickets - Selección");
		...
		btnModificar = new JButton("Modificar ticket");
		btnModificar.setBounds(81, 229, 171, 23);
